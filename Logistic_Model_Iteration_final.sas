...
%let infoval_data_path		= C:\Users\Desktop\	;	/* Provide the path of info val dataset generated by auto biining*/
%let Excel			= 1				;	/* 1=multiple excel file for each Iteration, 2=one excel file*/
%let output			= C:\Users\Desktop\	;	/* save output report in this location as C:\Users\Lenovo\ */;

/***************************************************************************************************************/

/*proc printto log="C:\Users\Desktop\Logistic_model.txt";*/
...
TM_SN_LST_KP_PTPST_ETYW
				 ...
				 ;
 		CODE file = 'C:\Users\Desktop\pprob.sas';	/* File pprob.sas saved in "C:\Users\pprob.sas" */
	run;

data VAL1;
   set VAL;
   %include 'C:\Users\Desktop\pprob.sas';
run;
