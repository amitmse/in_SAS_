*************************************************************************************;
/*https://statcompute.wordpress.com/2013/04/27/a-sas-macro-calculating-pdo/*/
*************************************************************************************;

options nocenter nonumber nodate mprint mlogic symbolgen orientation = landscape ls = 125 formchar = "|----|+|---+=|-/\<>*";
